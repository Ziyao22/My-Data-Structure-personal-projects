...
int main(int argc, char **argv) {
  ...
  name=argv[2];
    ...
    string word;
    while(file>>word){
      if(word!="ama"&&word!="amazi"&&word!="amaz"&&word!="amazin")
      newHash.insert(word);
    }
    ...
    for(int length1=3;length1<15;length1++){
      element=getWordInGrid(sr,sc,direction,length1,rows,cols);
      // if(element.length()==length1){
      // while(element.length()>length){
      if(newHash.find(element)&&element.length()==length1){
	if(direction==0)
        cout<<"N "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==1)
        cout<<"NE "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==2)
        cout<<"E "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==3)
        cout<<"SE "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==4)
	cout<<"S "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==5)
        cout<<"SW "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else if(direction==6)
        cout<<"W "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     else{
        cout<<"NW "<<"("<<sr<<", "<<sc<<"): "<<element<<endl;
     }
	numberOfWords++;
      }
      //numberOfWords++;
