...
int main(int argc, char ** argv) {
  ...
  name=argv[2];
    ...
    for(int sc=0;sr<cols;sc++){  
    for (int direction = 0;direction < 8;direction++){
    for(int length=0;length<25;length++){  
      //cout << i << ": " << getWordInGrid(2, 2, i, 10, rows, cols) << endl;
      
      element=getWordInGrid(sr,sc,direction,length,rows,cols);
      if(newHash.find(element)){
      if(direction==0)
	cout<<"N "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==1)
        cout<<"NE "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==2)
        cout<<"E "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==3)
        cout<<"SE "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==4)
        cout<<"S "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==5)
        cout<<"SW "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else if(direction==6)
        cout<<"W "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
     else
        cout<<"NW "<<"("<<sr<<", "<<cols<<"): "<<name<<endl;
      numberOfWords++;
      }  
    }
    }
